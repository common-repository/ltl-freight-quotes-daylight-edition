...
class EnDaylightFdo
{
    ...
    static public function en_cart_package($en_package, $key)
    {
        ...
        self::$en_fdo_meta_data['plugin_name'] = 'daylight';
        $accessorials['residential'] = get_option('en_quote_settings_residential_delivery_daylight') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('en_quote_settings_liftgate_delivery_daylight') == 'yes' ? true : false;
