        ...
        static public function en_location_data()
        {
            ...
            $en_location_data = [
                ...
                'en_enable_in_store_pickup' => [
                    ...
                    'class' => 'en_location_checkout_field ' . $disabled_plan,
                    'append' => ' data-optional="1" ',
                ],
                'en_in_store_pickup_miles' => [
                    ...
                    'class' => 'en_location_input_field ' . $disabled_plan,
                ...
                'en_in_store_pickup_phone' => [
                    ...
                    'label' => 'Phone number:',
                    'class' => 'en_phone_number en_location_input_field ' . $disabled_plan,
...
//      We can use hook for add new location field from other plugin add-on
            return apply_filters('en_daylight_add_location', $en_location_data);
        }
        ...
        static public function en_arrange_location_table_row($en_location_list, $en_data, $location_bol, $disabled_plan = '')
        {
            ...
            foreach ($en_location_list as $key => $location) {
                ...
                echo '<tr class="' . esc_attr($append_class) . '" id="en_location_row_id_' . $en_location_id . '">';
                ...
                echo '<a href="javascript(0)" onclick="return en_daylight_location_edit(event, this,' . $location_bol . ')"> <img src = "' . EN_DAYLIGHT_DIR_FILE . '/admin/tab/location/assets/images/edit.png" title = "Edit" ></a>';
                echo '<a href="javascript(0)" onclick="return en_daylight_location_delete(event, this,' . $location_bol . ' , ' . $en_location_id . ')"> <img  src = "' . EN_DAYLIGHT_DIR_FILE . '/admin/tab/location/assets/images/delete.png" title = "Delete" ></a>';
                echo '</td>';
        ...
        static public function en_load()
        {
            ...
            <div class="confirmation_location_delete en_popup_location_overly">
                <div class="en_popup_location_form en_hide_popup_location">
                    <a class="en_close_popup_location" href="#">×</a>

                    <h2 class="en_confirmation_warning">
                        Warning!
                    </h2>
                    <p class="en_confirmation_message">
                        If you delete this location, then location settings will be disabled against products
                        (if any).
                    </p>
                    <div class="en_confirmation_buttons">
                        <a href="#" class="button-primary en_location_cancel_delete">Cancel</a>
                        <a href="#" class="button-primary en_location_confirm_delete">OK</a>
                    </div>
                </div>
            </div>
            ...
            foreach ($en_location_data as $key => $value) {
                ...
                switch ($type) {
                    ...
                    case 'en_heading':
                        ...
                        echo "<span class='en_instore_pickup_notification'> $append_after </span>";
                        break;
            ...
            echo '<input type="submit" value="Save" class="en_daylight_location_btn button-primary">';
            echo '</form>';
            echo '</div>';
            echo '</div>';

            echo \EnDaylightWarehouseTemplate\EnDaylightWarehouseTemplate::en_load();
            echo \EnDaylightDropshipTemplate\EnDaylightDropshipTemplate::en_load();
        }
