...
namespace EnDaylightDropshipTemplate;

use EnDaylightWarehouse\EnDaylightWarehouse;

if (!class_exists('EnDaylightDropshipTemplate')) {

    class EnDaylightDropshipTemplate
    {
        ...
        {
            $en_heading = $en_data = [];
            $en_dropship_list = EnDaylightWarehouse::get_data(['location' => 'dropship']);
            ...
            echo \EnLocation::en_arrange_location_table_row($en_dropship_list, $en_data, 0);
