...
namespace EnDaylightProductDetail;

use EnDaylightWarehouse\EnDaylightWarehouse;

/**
 * Add and show simple and variable products.
 * Class EnDaylightProductDetail
 * @package EnDaylightProductDetail
 */
if (!class_exists('EnDaylightProductDetail')) {
    ...
    class EnDaylightProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnDaylightProductDetail constructor.
         */
        public function __construct()
        {
            ...
            if (!has_filter('En_Plugins_dropship_filter') &&
                ...
                $this->en_daylight_check_if_woo_payment_and_subscription_plugin_installed();
        ...
        {
            return EN_DAYLIGHT_DECLARED_TRUE;
        }
        ...
        {
            $dropship = EnDaylightWarehouse::get_data(['location' => 'dropship']);
            $en_dropship_list = [];
        ...
        public function en_product_fields_arr()
        {
            ...
            $en_product_fields = apply_filters('en_daylight_add_product', $en_product_fields);
         ...
         */
        public function en_daylight_check_if_woo_payment_and_subscription_plugin_installed()
        {
            $all_plugins = apply_filters('active_plugins', get_option('active_plugins'));
