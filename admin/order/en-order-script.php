...
namespace EnDaylightOrderScript;

/**
 * Script for send ajax request.
 * Class EnDaylightOrderScript
 * @package EnDaylightOrderScript
 */
if (!class_exists('EnDaylightOrderScript')) {
    ...
    class EnDaylightOrderScript
    {
         ...
         * EnDaylightOrderScript constructor.
         */
        public function __construct()
        {
            add_action('admin_print_scripts', [$this, 'en_daylight_order_script'], 50);
        }

        public function en_daylight_order_script()
        {
            global $post;
            ?>
                    ...
                    let data =
                        {
                            ...
                            'action': 'en_daylight_admin_order_quotes'
                        };
                    jQuery.ajax({
                        type: "POST",
                        url: ajaxurl,
