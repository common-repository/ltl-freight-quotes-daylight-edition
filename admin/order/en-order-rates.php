...
namespace EnDaylightOrderRates;

/**
 * Order page rates.
 * Class EnDaylightOrderRates
 * @package EnDaylightOrderRates
 */
if (!class_exists('EnDaylightOrderRates')) {
    ...
    class EnDaylightOrderRates
    {
         ...
         * EnDaylightOrderRates constructor.
         */
        public function __construct()
        {
            add_action('wp_ajax_nopriv_en_daylight_admin_order_quotes', array($this, 'en_daylight_admin_order_quotes'));
            add_action('wp_ajax_en_daylight_admin_order_quotes', array($this, 'en_daylight_admin_order_quotes'));
        }

        /**
         * Get quotes from calculate shipping forcefully
         */
        public function en_daylight_admin_order_quotes()
        {
            global $woocommerce;
            $errors = array();
            ...
            $shipping_class = new \EnDaylightShippingRates();
