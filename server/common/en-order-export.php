...
namespace EnDaylightOrderExport;

/**
 * Get and save settings.
 * Class EnDaylightOrderExport
 * @package EnDaylightOrderExport
 */
if (!class_exists('EnDaylightOrderExport')) {
    ...
    class EnDaylightOrderExport
    {
        ...
        {
            $store_name =  \EnDaylightConfig\EnDaylightConfig::en_get_server_name();
            $post_data = [
            ...
            $response = \EnDaylightCurl\EnDaylightCurl::en_daylight_sent_http_request(EN_DAYLIGHT_ORDER_EXPORT_HITTING_URL, $post_data, 'POST', 'Export Order');
