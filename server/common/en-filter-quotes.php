...
namespace EnDaylightFilterQuotes;

use EnDaylightVersionCompact\EnDaylightVersionCompact;

/**
 * Rates according selected rating method.
 * Class EnDaylightFilterQuotes
 * @package EnDaylightFilterQuotes
 */
if (!class_exists('EnDaylightFilterQuotes')) {
    ...
    class EnDaylightFilterQuotes
    {
        ...
        static public function average_rate()
        {
            ...
            $rate_list = EnDaylightVersionCompact::en_array_column(self::$quotes, 'cost');
